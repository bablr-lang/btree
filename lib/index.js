...
export const findPath = (idx, tree) => {
  ...
  let count = idx < 0 ? getSum(tree) : 0;
  let direction = idx < 0 ? -1 : 1;
  let targetIdx = idx < 0 ? count - idx : idx;
